...
Milestones 1 through 6 establish the technical foundation, secure authentication, project and member management, the task lifecycle, comments, and activity history. Search, notifications, and real-time updates remain reserved for their specified milestones.
...
The versioned migrations create the user, project, membership, board, task, comment, and activity tables required through Milestone 6.
